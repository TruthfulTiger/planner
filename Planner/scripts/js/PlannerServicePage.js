class PlannerServicePage {
    constructor() {
        ...
        this.AjaxAddIncomeClick = (e) => {
            let income = this.CalculateIncome($("#incomeAmount").val());
            ...
            $.ajax({
                ...
                data: '{ "income": { "incomeName":' + $("#incomeName").val() +
                    ...
                    '"amountWk":' + income.getWklyAmt +
                    '"amountMth":' + income.getMthlyAmt +
                    '"amountTm":' + income.getTmlyAmt +
                    '"amountQt":' + income.getQtlyAmt +
                    '"amountYr":' + income.getYrlyAmt +
                    '} }',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        this.AjaxAmountSendSuccessful = (json, status, req) => {
            window.alert("Income amount added successfully\n Status: " + status);
        };
